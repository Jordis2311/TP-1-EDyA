 ...
 * el codigo asignado por el arbol de huffman a cada caracter donde:
 * - texto es el archivo a comprimir. len es la longitud de dicho archivo
 * - codigos es una lista de strings conteniendo el codigo de cada caracter 
 * ordenada segun el caracter que representan.
 ...
 * y la longitud de su codigo correspondiente, el tamaño final que tendra 
 * nuestra traduccion antes del implode
 */
 ...
 * Esto se repite hasta que no haya mas bits, retornando el array escrito y 
 * guardando en un *int su longitud.
